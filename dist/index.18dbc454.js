...
$(document).ready(function() {
    ...
    function removeLine() {
        ...
        if (lines > 1) prompt.append(promptInputCursor);
        else {
            promptInputField.focus();
    ...
    function checkWidth() {
        if (lines.length > 1) return prompt.find(".prompt__input__value").last().width() + promptInputCursor.width() * 2 >= prompt.width();
    ...
    promptInputField.on("input", function(e) {
        ...
        promptInputField.val(promptInputField.val().replace(/ /g, "\xa0"));
...
},{"./import-jquery":"i30G9","./commands":"d4bRr","jquery-ui-dist/jquery-ui":"bD9NY","jquery-ui-dist/jquery-ui.css":"3KFhY"}],"i30G9":[function(require,module,exports) {
...
},{}],"d4bRr":[function(require,module,exports) {
// Command interpreter
//
...
class Modal {
    ...
    resizeEventListener() {
        this.modal.on("resize", ()=>{
            this.modal.draggable("option", "containment", [
                0,
                0,
                $(parent).width() - this.modal.width() - 5,
                $(parent).height() - this.modal.height() - 5
            ]);
        });
    }
    ...
    initialize() {
        ...
        this.modal.draggable({
            ...
            containment: [
                0,
                0,
                $(window).width() - this.modal.width() - 5,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bD9NY":[function(require,module,exports) {
...
},{}],"3KFhY":[function() {},{}]},["1SICI"], "1SICI", "parcelRequire2041")
